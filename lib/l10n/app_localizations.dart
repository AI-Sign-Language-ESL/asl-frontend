...
abstract class AppLocalizations {
  ...
  /// No description provided for @organizationSignup.
  ///
  /// In en, this message translates to:
  /// **'Organization Sign Up'**
  String get organizationSignup;
  ...
  /// No description provided for @mainDescription.
  ///
  /// In en, this message translates to:
  /// **'Real-time bidirectional translation between Sign Language and spoken voice. Powered by advanced computer vision and generative AI to create a world where communication has no barriers.'**
  ...
  /// No description provided for @textOrAudioOutput.
  ///
  /// In en, this message translates to:
  /// **'Text or resulting audio'**
  String get textOrAudioOutput;
  ...
  /// No description provided for @signInterpreter.
  ///
  /// In en, this message translates to:
